...
| osdisk\_encryption\_key\_encryption\_key\_urls | The list of ID of the key valut key resource. This can be obtained from `id` attribute of `key_vault_key resource` | `list(string)` | <pre>[<br>  ""<br>]</pre> | no |
