...
|------|-------------|------|---------|:-----:|
| An additional\_unattend\_config block. | Should the Azure Virtual Machine Guest Agent be installed on this Virtual Machine? | `list` | `[]` | no |
...
| storage\_os\_disk\_size\_gb | Specifies the size of the OS Disk in gigabytes. | `number` | `8` | no |
...
| vm\_size | Specifies the size of the Virtual Machines. https://docs.microsoft.com/en-us/azure/virtual-machines/windows/sizes?toc=%2Fazure%2Fvirtual-machines%2Fwindows%2Ftoc.json. | `string` | `"B"` | no |
